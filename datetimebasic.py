...
#get the elements of the date and time today.year
year = today.year
month = today.month
day = today.day
...
indenpendence_day = datetime.date(year= 1945, month=8, day=17)
print(indenpendence_day)

#create your own the datetime.time()
...
print(indenpendence_day.strftime("%B %d, %Y"))
