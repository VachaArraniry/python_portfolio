...
playstation_4 = Product(id=1, title='Playstation 4', price=4500000,
                        quantity=4, description='A good gane console.')
vintage_gameboy = Product(id=2, title='Vintage GameBoy', price=800000,
                          quantity=3, description='A vintage portable game')
